...
import {LanguageContext} from '../../components/providers/LanguageProvider/context/LanguageContext';
...
export function useAppPartialTranslation<T extends FreeFormTranslationKeysObject>(
  ...
  return {t, p, f, i18n: subKeys, translations: translations[language.language]};
}
